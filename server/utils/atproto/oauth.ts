...
import {
  ...
  NET_ATVIEW_MANAGED_ROLE_WRITE_SCOPE,
  NET_ATVIEW_NESTED_WRITE_SCOPE,
  NET_ATVIEW_SPONSOR_WRITE_SCOPE,
  PROFILE_SCOPE,
...
export const scope = `atproto ${LIKES_SCOPE} ${PROFILE_SCOPE} ${NET_ATVIEW_ACCOUNT_ACTOR_WRITE_SCOPE} ${NET_ATVIEW_ECOSYSTEM_WRITE_SCOPE} ${NET_ATVIEW_NESTED_WRITE_SCOPE} ${NET_ATVIEW_SPONSOR_WRITE_SCOPE} ${NET_ATVIEW_ACCOUNT_ROLE_WRITE_SCOPE} ${NET_ATVIEW_MANAGED_ROLE_WRITE_SCOPE}`
